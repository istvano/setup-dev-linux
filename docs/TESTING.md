...
Source/implementation details: [SDKMAN](SDKMAN-REVIEW.md), [Java](JAVA-REVIEW.md).
...
Source and fixture limits are in [JVM-TOOLS-REVIEW.md](JVM-TOOLS-REVIEW.md).
...
[Mandrel review](MANDREL-REVIEW.md) for source/licence and Ubuntu package details.
...
compatibility remain unverified. Source and delivery details are in [Go review](GO-REVIEW.md).
...
state ownership details are in [Rust review](RUST-REVIEW.md).
...
Source and delivery details are in [Python review](PYTHON-REVIEW.md),
[OpenCode review](OPENCODE-REVIEW.md) and [agent gates](AGENT-REVIEW.md).
...
acceptance remain unfinished. See [Codex source review](CODEX-REVIEW.md),
[agent gates](AGENT-REVIEW.md), [F02 handoff contract](../specs/F02-storage-guard.md)
...
and physical hardware acceptance remain unfinished. See [Cline source review](CLINE-REVIEW.md),
[agent gates](AGENT-REVIEW.md) and [unfinished tasks](../TASKS.md).
